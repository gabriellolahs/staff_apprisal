...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($staff && password_verify($current, $staff['password'])) {
        if ($new === $confirm) {
            ...
            if ($update->execute()) {
                echo "<script>alert('Password updated successfully!'); window.location='non_academic_dashboard.php';</script>";
            }
        } else {
...
<body>
    ...
    <div class="sidebar">
        ...
        <h2>NON-ACADEMIC MENU</h2>
        <a href="non_academic_dashboard.php">🏠 Dashboard</a>
        <a href="non_academic_profile.php">👤 Profile</a>
        <a href="non_academic_appraisal.php">📝 Appraisal</a>
        <a href="non_academic_reports.php">📊 Reports</a>
        <a href="non_set_password.php">Set Password</a>
    ...
    <div class="main-content">
        ...
        <div class="card p-4 bg-white">
            <form method="POST">
                ...
                <a href="non_set_password.php" class="btn-back">Back</a>
            </form>
        </div>
        </div>
    </div>
