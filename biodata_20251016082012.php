...
<div class="main">
  ...
  <?php endif; ?>
    ...
    <option value="<?php echo $biodata['school']; ?>">
        <?php echo htmlspecialchars($biodata['school_name'] ?? ''); ?>
    </option>
</select>
          <?php
    ...
    <option value="<?php echo $biodata['department']; ?>">
        <?php echo htmlspecialchars($biodata['department_name'] ?? ''); ?>
    </option>
</select>
      </div>
      <div class="col-md-3">
