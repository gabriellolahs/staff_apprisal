...
<head>
    ...
    display: flex;
    background: url('your-logo.png') no-repeat center center fixed;
    background-size: cover;
        }
        /* Sidebar */
        .sidebar {
            width: 250px;
            background: url('20250918_172219.jpg') no-repeat center center fixed;
    background-size: cover;
            height: 100vh;
            position: fixed;
            left: 0;
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="logout.php">🚪 Logout</a>
         <footer>
    <p>Powered by <a href="https://wa.me/qr/3MCBSQUMTBQRJ1">Thrive's Multiplex Enterprise</a></p>
</footer>
    </div>
