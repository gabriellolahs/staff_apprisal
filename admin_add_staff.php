<?php
require_once "admin_add_staff.php";
session_start();
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_sql = "DELETE FROM allowed_staff WHERE id = ?";
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="admin_panel.php">➕ lock</a>
        <a href="manage_staff.php">👥 Manage Staff</a>
        <a href="admin_appraisal_panel.php">👥 View Appraisal</a>
        <a href="admin_review.php">Unlock & Approve Appraisals</a>
