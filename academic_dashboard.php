...
<div class="sidebar">
    ...
    <h2>ACADEMIC MENU</h2>
    <a href="academic_dashboard.php" class="active"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
    <a href="biodata.php"><i class="fas fa-id-card"></i> My Biodata</a>
    <a href="staff_appraisal.php"><i class="fas fa-clipboard-list"></i> Annual Appraisal</a>
    <a href="academic_reports.php"><i class="fas fa-chart-bar"></i> Reports & Analytics</a>
    <a href="set_password.php"><i class="fas fa-key"></i> Set/Change Password</a>
...
<div class="main-content">
    <div class="welcome-card">
        ...
        <p>Academic Staff Portal • Federal Polytechnic Ile-Oluji</p>
    </div>
    ...
    <div class="profile-card">
        <div class="profile-header">
            ...
            <div class="profile-info">
                ...
                <p><strong>Category:</strong> <?= $staff['category'] ?? 'N/A' ?></p>
                <p><strong>Department:</strong> <?= $staff['department'] ?? 'Not Set' ?></p>
                <p><strong>Faculty:</strong> <?= $staff['faculty'] ?? 'Not Set' ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="info-grid">
        <div class="info-card">
            ...
            <a href="biodata.php">Go to Biodata</a>
        </div>
        <div class="info-card"> 
            <i class="fas fa-clipboard-list"></i>
            <h3>Annual Appraisal</h3>
            <p>Complete your performance appraisal form</p>
            <a href="staff_appraisal.php">Start Appraisal</a>
        </div>
        <div class="info-card">
            <i class="fas fa-chart-bar"></i>
            <h3>Reports</h3>
            <p>View your appraisal history and status</p>
            <a href="academic_reports.php">View Reports</a>
        </div>
        <div class="info-card">
